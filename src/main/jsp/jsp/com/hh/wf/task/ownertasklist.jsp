...
<script type="text/javascript">
	...
	function daterender(value,data){
		...
		var currDateLong = $.hh.getDate().getTime();
		if(data.taskEndTime){
			currDateLong = $.hh.stringToDate(data.taskEndTime).getTime();
		}
		
		var durationInMillis = $.hh.millisecondTOHHMMSS(currDateLong-$.hh.stringToDate(data.taskStartTime).getTime());
...
<body>
	...
	<div id="pagelist" xtype="pagelist"
		config=" radio:true, url: 'wf-WFOper-queryOwnerTaskPage' ,column : [
		{
			name : 'piName' ,
			text : '流程名称',
			width : '60%'
